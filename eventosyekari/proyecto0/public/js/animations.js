...
document.addEventListener("DOMContentLoaded", () => {
    ...
    toggleButtons.forEach((button) => {
        button.addEventListener("click", function () {
            ...
            // Alternamos clase "active" tanto en el botón como en el contenedor
            // - La clase "active" puede usarse en CSS para controlar la visibilidad, altura, transición, etc.
