...
<body>
    ...
    <!-- Header: Contiene navegación principal y marca (logo + nombre) -->
    <header class="site-header">
        <!-- Barra de navegación principal -->
        <nav class="nav" aria-label="Menú principal">
            <!-- Enlaces de navegación: ancla a secciones internas o páginas -->
        ...
        <div class="brand">
            <!-- Imagen del logo; onerror reemplaza por un SVG embebido si falla la carga -->
    ...
    <!-- Footer: información de la empresa y enlaces a redes sociales -->
    <footer class="main-footer">
        <div class="container">
            <div class="footer-content">
                ...
                <!-- Sección de redes sociales: iconos con enlaces externos -->
                <div class="footer-section">
                    <h4>Síguenos</h4>
            ...
            <!-- Línea inferior del footer con derechos de autor -->
